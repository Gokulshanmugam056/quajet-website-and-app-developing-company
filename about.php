...
<html lang="en">
    <head>
        ...
        <title>About QUAJET Job Portal</title>
            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="index.html">
                    ...
                    <div class="d-flex flex-column">
                        <strong class="logo-text">QUAJET</strong>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h1 class="text-white">About QUAJET</h1>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="about-info-text">
                                <h2 class="mb-0">Introducing QUAJET Job</h2>

                                <h4 class="mb-2">Get hired. Get your new job</h4>

                                <p>Thank you for visiting our QUAJET Job website. Are you looking for best Website (or) App Developer ? Please visit Quajet website to make new one.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 d-flex align-items-center">
                            <p class="copyright-text">Copyright © Quajet
                                 Job 2048</p>
